...
handStartPos = [0, 0, 2]
handStartOrientation = p.getQuaternionFromEuler([0, 1, 0])
handId = p.loadURDF("/home/patrick/contact/allegro_hand_ros/allegro_hand_description/allegro_hand_description_left.urdf", handStartPos, handStartOrientation, globalScaling=8)
